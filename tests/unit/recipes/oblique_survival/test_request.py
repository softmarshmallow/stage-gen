...
from ember_hollow_pipeline.models import Package, SourceError
from ember_hollow_pipeline.survival_request import (
    load_package,
    resolve_survival_source,
    take_path,
)

PACKAGE = Path("godot/games/ember_hollow/inputs")
