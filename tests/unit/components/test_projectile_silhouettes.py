...
from stage_gen_legacy.components.platformer_content.models import ProjectileSilhouette
from stage_gen_legacy.components.platformer_content.projectile_silhouettes import (
