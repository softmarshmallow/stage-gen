...
from demo_game_tools.input_formats.sideview_content.models import ProjectileSilhouette
from demo_game_tools.input_formats.sideview_content.projectile_silhouettes import (
