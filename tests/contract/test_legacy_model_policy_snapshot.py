...
from stage_gen_legacy.model_policy import load_active_model_policy_snapshot

REPOSITORY_ROOT = Path(__file__).resolve().parents[2]
WRITER = REPOSITORY_ROOT / "godot/legacy/tools/write_model_policy_snapshot.py"
SNAPSHOT = REPOSITORY_ROOT / "godot/legacy/python/stage_gen_legacy/model_policy_snapshot.json"
