...
WRITER = REPOSITORY_ROOT / "godot/tools/write_game_model_policy_snapshot.py"
SNAPSHOT = (
    REPOSITORY_ROOT / "godot/tools/python/src/demo_game_collection/model_policy_snapshot.json"
)
