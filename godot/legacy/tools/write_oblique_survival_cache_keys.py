...
reads and prices rather than a surprise on the next run.
    ...
    uv run python godot/legacy/tools/write_oblique_survival_cache_keys.py          # check
    uv run python godot/legacy/tools/write_oblique_survival_cache_keys.py --write  # rewrite
...
PACKAGE = REPOSITORY_ROOT / "godot/legacy/inputs/ember-hollow"
