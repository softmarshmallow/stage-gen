#!/usr/bin/env python3
"""Check or rewrite historical demo graph snapshots.

These executable contracts belong to the preserved demo builders. New asset
pipelines do not inherit their gameplay stages or fixture requirements.

    python godot/legacy/tools/write_pipeline_graph_contract.py
    python godot/legacy/tools/write_pipeline_graph_contract.py --write
"""
...
if __package__ in {None, ""}:
    ...
    sys.path.insert(0, str(Path(__file__).resolve().parents[3] / "godot/legacy/python"))
...
from stage_gen_legacy.orchestration.game_package import resolve_game_package
...
RUNNER_FIXTURE_REF = "godot/legacy/inputs/iron-petal-unit"
...
OBLIQUE_SURVIVAL_FIXTURE_REF = "godot/legacy/inputs/ember-hollow"
...
STOREFRONT_FIXTURE_REF = "godot/legacy/inputs/ember-hollow"
