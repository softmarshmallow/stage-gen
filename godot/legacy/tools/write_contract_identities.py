...
The table in :mod:`stage_gen_legacy.identities` reads every persisted identity from the code that
...
``tests/contract/test_contract_identities.py`` asserts the document matches.
    ...
    uv run python godot/legacy/tools/write_contract_identities.py          # check
    uv run python godot/legacy/tools/write_contract_identities.py --write    # rewrite the document
"""
...
def render() -> str:
    lines = [
        ...
        "godot/legacy/tools/write_contract_identities.py --write`. -->",
