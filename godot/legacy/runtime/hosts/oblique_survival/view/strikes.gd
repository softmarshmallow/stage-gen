...
## burst (:5586).
##
## The twelve-particle sparkle that lands with the bolt is spawned by `SurvivalPuffs`,
...
const SHADER_PATH := "res://hosts/oblique_survival/view/shaders/fx_card.gdshader"
## `ORDER.particle`.
...
## contract (index.html :442-448). Shared with SurvivalWeatherView, which drives the
