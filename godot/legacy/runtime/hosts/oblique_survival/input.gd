...
## one step (`SurvivalSim.clear_one_shots` wipes it, as the viewer's loop does).
##
...
## engine's action singleton. The class is `SurvivalInput`; the path is unchanged.
