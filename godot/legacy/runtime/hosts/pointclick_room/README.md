...
```sh
Godot --path godot/legacy/runtime res://hosts/pointclick_room/main.tscn -- --run <absolute run directory>
```
...
- **The narration ran off its plate.** A 156px plate has a 52px interior; the
  ...
  by two pixels. `godot/legacy/runtime/tests/test_room_layout.gd` holds the fitting, and at 168
