...
def _owner_module(module: str) -> str:
    prefixes = (
        "orchestration.game_package",
        "orchestration.package_capture",
        "components.game_",
        "components.platformer_",
        "components.runner_",
        "components.case",
        "components.sideview_stage",
        "recipes.sideview_platformer",
        "recipes.sideview_runner",
        "recipes.oblique_survival",
        "recipes.dialogue_scene",
        "recipes.pointclick_room",
    )
    package = "stage_gen_legacy" if module.startswith(prefixes) else "stage_gen"
