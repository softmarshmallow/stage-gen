...
- lives in `stage_gen_legacy.orchestration.case_binding`, because a component may not
...
from stage_gen_legacy.components.case.models import (
    CASE_CATALOG_NAME,
    CaseAdmissionReport,
    CaseCatalog,
    CaseDocument,
)
from stage_gen_legacy.components.case.proof import admit_case
