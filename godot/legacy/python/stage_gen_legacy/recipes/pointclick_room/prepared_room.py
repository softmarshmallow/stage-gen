...
from stage_gen_legacy.recipes.pointclick_room.models import RoomReference, prove_room_solvable
...
from stage_gen_legacy.recipes.pointclick_room.room_types import (
    BACKDROP_GENERATE,
...
if TYPE_CHECKING:
    ...
    from stage_gen_legacy.recipes.pointclick_room.room_request import ResolvedPointClickRoom
