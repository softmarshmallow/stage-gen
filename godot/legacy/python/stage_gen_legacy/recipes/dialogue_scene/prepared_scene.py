...
from stage_gen_legacy.recipes.dialogue_scene.manifest import write_dialogue_bundle
...
from stage_gen_legacy.recipes.dialogue_scene.policy import POLICY_DIGEST
from stage_gen_legacy.recipes.dialogue_scene.prompts import base_plate_prompt, expression_prompt
...
from stage_gen_legacy.recipes.dialogue_scene.scene_types import (
    BACKDROP_GENERATE,
    BUNDLE_PACKAGE,
    CONCEPT_INGEST,
    CONCEPT_KIND,
...
from stage_gen_legacy.recipes.dialogue_scene.schema import dialogue_plan_json_schema
...
if TYPE_CHECKING:
    ...
    from stage_gen_legacy.recipes.dialogue_scene.models import DialoguePlan
