...
from stage_gen_legacy.components.game_ui.nodes import AtlasRoleLayout, IconSetLayout
...
class DialogueSceneDocument(PersistedContractModel):
    ...
    One scene = one directory under ``godot/legacy/inputs/`` holding this document
