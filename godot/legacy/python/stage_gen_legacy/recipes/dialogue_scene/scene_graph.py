...
from stage_gen_legacy.recipes.dialogue_scene.identity import canonical_json_bytes
from stage_gen_legacy.recipes.dialogue_scene.prompts import (
    background_prompt,
    plan_prompt,
    track_prompt,
    ui_atlas_prompt,
...
if TYPE_CHECKING:
    ...
    from stage_gen_legacy.recipes.dialogue_scene.scene_request import ResolvedDialogueScene
