...
from stage_gen_legacy.components.platformer_content import projectile_silhouette_art
...
if TYPE_CHECKING:
    from stage_gen_legacy.components.runner_content import RunnerAvatar, RunnerBoss
