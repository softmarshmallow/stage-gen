...
from stage_gen_legacy.components.game_fx.sprite import validate_dust_atlas
from stage_gen_legacy.components.game_soundtrack import SoundtrackTrack
from stage_gen_legacy.components.game_soundtrack.nodes import SoundtrackHandlers, SoundtrackHost
from stage_gen_legacy.components.game_soundtrack.prompt import music_track_prompt
from stage_gen_legacy.components.runner_audio import RunnerAudioContract
from stage_gen_legacy.components.runner_audio.realizations import (
...
from stage_gen_legacy.recipes.sideview_runner.runner_prompts import (
    layer_loop_prompt,
    soundtrack_direction,
    visual_direction_digest,
)
from stage_gen_legacy.recipes.sideview_runner.runner_types import (
    ATTEMPT_LEDGER_KIND,
    AUDIO_REPUBLISH,
...
if TYPE_CHECKING:
    ...
    from stage_gen_legacy.components.game_voices import GameVoice
    from stage_gen_legacy.components.platformer_map import PreparedMapLayer
    from stage_gen_legacy.components.runner_track import RunnerSegmentChunk, RunnerTrack
    from stage_gen_legacy.recipes.sideview_runner.runner_request import ResolvedRunnerPackage
