...
from stage_gen_legacy.components.game_ui import inventory_panel_layout_contract
from stage_gen_legacy.components.game_ui.nodes import (
    document_roles,
    ui_atlas_manifest_block,
)
from stage_gen_legacy.components.platformer_content import MotionPresentation, PropContent
from stage_gen_legacy.components.platformer_map import PreparedGameMap, PreparedMapLayer
...
from stage_gen_legacy.recipes.sideview_platformer.terrain_design import terrain_artifact_path
from stage_gen_legacy.recipes.sideview_platformer.validation import ResolvedGamePackage
