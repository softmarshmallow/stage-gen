...
from stage_gen_legacy.components.game_contract import PlatformerGenreMember, PreparedGameContract
from stage_gen_legacy.components.game_soundtrack import GameSoundtrack, load_game_soundtrack_bytes
from stage_gen_legacy.components.game_ui import GameUi, load_game_ui_bytes
...
from stage_gen_legacy.components.platformer_gameplay import (
    GameplayContract,
    GrantItemEffect,
    SetQuestStateEffect,
