...
from stage_gen_legacy.components.game_soundtrack.nodes import (
    SoundtrackNodeTypes,
...
from stage_gen_legacy.components.game_ui.nodes import add_ui_atlas_nodes, document_roles
from stage_gen_legacy.components.platformer_content import (
    DEFAULT_MOTION_ANCHOR,
    ContentReference,
    MotionPresentation,
)
from stage_gen_legacy.components.platformer_map import PreparedGameMap, PreparedMapReference
from stage_gen_legacy.orchestration.game_package import ResolvedGamePackage
from stage_gen_legacy.recipes.sideview_platformer.climbable_atlas import plan_climbable_atlas
...
from stage_gen_legacy.recipes.sideview_platformer.package_types import (
