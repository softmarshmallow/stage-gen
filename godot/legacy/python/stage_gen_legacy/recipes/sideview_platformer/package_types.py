...
from stage_gen_legacy.components.game_soundtrack.nodes import soundtrack_node_types
from stage_gen_legacy.components.game_ui.inventory_nodes import inventory_node_types
