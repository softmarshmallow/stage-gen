...
from stage_gen_legacy.components.game_shell import GameShell, load_game_shell_bytes
from stage_gen_legacy.components.game_shell.nodes import document_clip_roles
