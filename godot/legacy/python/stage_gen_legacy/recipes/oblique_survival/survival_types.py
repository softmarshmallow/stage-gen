...
from stage_gen_legacy.components.game_shell.nodes import SHELL_NODE_TYPES
from stage_gen_legacy.components.game_ui.nodes import UI_ATLAS_NODE_TYPES
...
OBLIQUE_SURVIVAL_NODE_TYPES: Final[tuple[NodeType, ...]] = (
    ...
    *UI_ATLAS_NODE_TYPES,
    # The shared game_shell triplet, planned over shell.toml the same way.
    *SHELL_NODE_TYPES,
    WORLD_LAYOUT,
    PACKAGE_MANIFEST,
)
