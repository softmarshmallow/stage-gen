...
When the story comes into git, the spike moves as it is. `godot/legacy/inputs/the_grain/`
...
- Movie: Episode One outlined 2026-09-03, provisional. The director chose to go straight
  ...
  game script is written in the closed vocabularies inside `godot/legacy/inputs/the_grain/` by
