...
func _run() -> void:
	...
	if _errors.is_empty(): print("PASS Local Content: isolated roots, strict relative bindings, symlinks, JSON diagnostics, PNG/WebP and WAV decoding, hash verification, invalid configuration and video container rejection")
