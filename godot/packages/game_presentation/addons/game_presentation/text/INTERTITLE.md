...
Hosts can separately compose [Text Reveal Audio](../audio/TEXT_REVEAL_AUDIO.md) from its
...
```sh
Godot --headless --path godot/games/command_link --script res://qa/intertitle_checks.gd
```
