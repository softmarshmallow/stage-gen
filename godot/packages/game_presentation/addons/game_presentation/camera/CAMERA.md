...
[establishing_shot.gd](establishing_shot.gd) owns deterministic timing and shot
settings. [presentation_stage.gd](../../../../../games/command_link/presentation/stage.gd) owns the background
...
profile from [the location catalog](../../../../../games/command_link/assets/locations/catalog.json) with any
...
[location_lens_flare.gdshader](../effects/shaders/location_lens_flare.gdshader) draws an
...
[The route adapter](../../../../../games/command_link/lab/establishing_shot.gd) starts at Coastal Staging.
...
The exact user request is [P24](../../../history/USER_PROMPTS.md#p24). Art acceptance belongs
to [the tactical location review](../../../../../games/command_link/art/rounds/tactical-locations-v1/REVIEW.md);
runtime checks and visual evidence belong to [QA.md](../../../history/QA.md).
