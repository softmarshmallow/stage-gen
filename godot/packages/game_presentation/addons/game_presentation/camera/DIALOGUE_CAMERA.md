...
[dialogue_camera.gd](dialogue_camera.gd) owns one camera pose and its transition.
...
[presentation_stage.gd](../../../../../games/command_link/presentation/stage.gd) exposes:
...
The exact user request is [P26](../../../history/USER_PROMPTS.md#p26). Final runtime checks
and independent visual evidence are recorded in [QA.md](../../../history/QA.md).
