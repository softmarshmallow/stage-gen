...
[Presentation Animation contract](../motion/ANIMATION.md), also used by
[Manpu Introduction](MANPU.md). The five scalar channels are
...
[Manpu Introduction](MANPU.md). The dialogue backing and UI remain
