...
in [presentation_animation.gd](presentation_animation.gd). [Actor Focus](../actors/ACTOR_FOCUS.md),
[Manpu Introduction](../actors/MANPU.md), [Character Exit](../actors/CHARACTER_EXIT.md),
and [Cast Transition](../actors/CAST_TRANSITIONS.md) use its track validation,
...
[motion_curve.gd](motion_curve.gd) supplies `validate(settings)` and
...
[motion_curve_graph.gd](../../../../../games/command_link/presentation/animation/motion_curve_graph.gd), so the preview reflects the actual
...
scalar tracks. The [Cast Transition contract](../actors/CAST_TRANSITIONS.md)
