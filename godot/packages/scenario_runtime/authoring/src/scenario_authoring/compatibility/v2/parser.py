"""Parse the supported, line-oriented v2 `.scenario` narrative language.

Statements retain their existing spelling and source-line diagnostics. Parsed
conditional runs are folded by the compiler; name resolution and bounded flow
checks belong to admission. The parser performs no game, media or provider work.
"""
...
from ._validation import SNAKE_ID_PATTERN
from .models import (
    SLOTS,
    AudioStatement,
    ChoiceOption,
