...
const Plates := preload("res://hosts/oblique_survival/view/plates.gd")
const ProcNoise := preload("res://hosts/oblique_survival/view/proc_noise.gd")
...
func setup(pkg, world, fu) -> void:
	...
	material.shader = load("res://hosts/oblique_survival/view/shaders/ground.gdshader")
