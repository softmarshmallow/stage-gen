...
## `SurvivalShadows`, `SurvivalDecals` and `SurvivalGallery` read them from here rather than keeping a
## second copy.
...
const CARD_SHADER := "res://hosts/oblique_survival/view/shaders/card.gdshader"
const CARD_SOFT_SHADER := "res://hosts/oblique_survival/view/shaders/card_soft.gdshader"
const CARD_BLEND_SHADER := "res://hosts/oblique_survival/view/shaders/card_blend.gdshader"

## Where a fading card sits in the transparent pass. SurvivalDecals are 1 and the
...
# --- pure helpers, shared with SurvivalShadows, SurvivalDecals and SurvivalGallery ------------------
...
## index (`SurvivalPieces.set_highlight`), and the frame owner hands the same hover to
