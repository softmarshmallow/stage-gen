class_name SurvivalFrameUniforms
extends RefCounted
...
static func from_manifest(manifest: Dictionary, resolution: Vector2) -> SurvivalFrameUniforms:
	var fu := SurvivalFrameUniforms.new()
