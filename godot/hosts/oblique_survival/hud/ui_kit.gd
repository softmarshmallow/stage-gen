...
# ===========================================================================
# Reading the world (the sim's own helpers are typed `SurvivalWorld`; these read the
...
## `SurvivalInventory.equip_kind`, read off a manifest so a panel can ask.
