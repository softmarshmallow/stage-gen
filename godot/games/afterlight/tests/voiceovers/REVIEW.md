...
```sh
Godot --headless --path godot/games/afterlight --script res://tests/voiceover_checks.gd -- --game afterlight
Godot --path godot/games/afterlight --script res://tests/voiceover_checks.gd -- --game afterlight --require-recordings --capture
```
