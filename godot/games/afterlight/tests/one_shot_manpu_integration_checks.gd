...
const FALLING_DIRECTORY := "res://tests/falling-sweat"
var _app: Control
...
func _check_menu() -> void:
	...
	var study := await _open("game:lab/sigh_puff_study")
...
func _check_falling_sweat_hosts() -> void:
	...
	var sources := {}
	for path: String in ["res://addons/game_presentation/actors/presets/manpu.json", "res://addons/game_presentation/actors/manpu_animation.gd", "res://cast_stage.gd", "res://story.gd", "res://story_beats.gd", "res://lab/sigh_puff_study.gd", "res://lab/billboard_puff_preview.gd"]:
