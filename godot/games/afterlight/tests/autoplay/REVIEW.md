...
| Source | SHA-256 |
| --- | --- |
| `story.gd` | `5dd8ead2283fd80916d4eb94d076a6f6825f095e2f9cfaf818cdda628aa90763` |
...
```sh
Godot --path godot/games/afterlight --script res://tests/autoplay_checks.gd -- --game afterlight --capture-autoplay
```
