...
[Sprite Particle Emitter checks](../../../../packages/game_presentation/tests/ambient_particle_checks.gd) pass seeded
...
```sh
Godot --path godot/games/afterlight --log-file /tmp/ambient-transmission-native.log --script res://tests/ambient_transmission_integration_checks.gd -- --game afterlight --language ko --capture-atmosphere
```
