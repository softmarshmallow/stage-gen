...
const OUTPUT := "res://tests/ambient-voice-lab"
var _app: Control
...
func _run() -> void:
	...
	root.add_child(_app)
	await _settle()
	_expect(_app.selected_game_id == "lab", "Run the check with --game lab.")
	if _app.selected_game_id != "lab":
		quit(2)
		return
	...
	for path: String in ["res://lab/ambient_particles_study.gd", "res://lab/transmission_voice_study.gd", "res://lab/effects_menu.gd", "res://games/presentation_lab/root.gd", "res://atmosphere_profile.gd", "res://addons/game_presentation/effects/particles/ambient_particles.gd", "res://addons/game_presentation/audio/voice_effects.gd", "res://addons/game_presentation/audio/text_reveal_audio.gd"]:
