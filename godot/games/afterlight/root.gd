...
const VOICE_POLICY = preload("res://voice/voice_policy.gd")
...
const CONTENT := {
	"backgrounds": [
		{
			...
			"path": "res://assets/locations/conservatory_lounge.png",
		},
		{
			"id": "reading_lounge",
			"path": "res://assets/locations/reading_lounge.png",
		},
		{
			"id": "keeper_hall",
			"path": "res://assets/locations/keeper_hall.png",
		},
		{
			"id": "relay_alcove",
			"path": "res://assets/locations/relay_lab.png",
		},
	],
	...
	"guests": [
		{
			...
			"path": "res://assets/characters/nami_standing.png",
			"eye_uv": [0.493, 0.146],
			"eye_close_path": "res://assets/characters/nami_close.png",
			"eye_close_uv": [0.487, 0.334],
			"eye_close_height": 1050.0,
			"detail_path": "res://assets/characters/nami_detail.png",
			"detail_height": 1600.0,
			"detail_y": -200.0,
			"contact_path": "res://assets/characters/nami_contact.png",
		...
		},
		{
			...
			"path": "res://assets/characters/sena_standing.png",
			"eye_uv": [0.496, 0.137],
		},
		{
			"id": "riko",
	...
	"supporting_cast": [
		{
			"id": "keeper",
			"path": "res://assets/characters/keeper_standing.png",
			"eye_uv": [0.49, 0.09],
		},
		{
			"id": "eira",
			"path": "res://assets/characters/eira_portrait.png",
			"eye_uv": [0.47, 0.28],
...
func prepare_scene(scene: Control, route_id: String, options: Dictionary, saved_state: Dictionary) -> void:
	...
	for language: String in LANGUAGES:
		var parsed: Dictionary = _content_loader.read_json("text/" + language + ".json")
