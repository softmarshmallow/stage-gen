...
> Historical presentation chronology before the Scenario cutover. Art, voice and
> effect reviews remain evidence of their stated scopes. Code-director ownership,
> checkpoint versions and deferred statuses below describe that earlier state;
> [the current game guide](../README.md) and [Scenario contract](../../../packages/scenario_runtime/docs/contract.md)
> govern current authoring and execution.
...
```sh
Godot --path godot/games/afterlight -- --game afterlight --language ko
```
...
dialogue. Eira's existing voice recordings use [Transmission Voice processing](../../../packages/game_presentation/addons/game_presentation/audio/VOICE_PROCESSING.md)
...
[Presentation Lab](../../command_link/lab/README.md), whose prepared fixtures have
...
[Point Contact](../../../packages/game_presentation/addons/game_presentation/interaction/POINT_CONTACT.md) behavior only tests
...
before the Keeper appears. The [Eye Transition contract](../../../packages/game_presentation/addons/game_presentation/transitions/EYE_TRANSITIONS.md)
...
```sh
Godot --headless --path godot/games/afterlight --script res://tests/afterlight_ensemble_checks.gd -- --game afterlight
Godot --headless --path godot/games/afterlight --script res://tests/presentation_lab_checks.gd
```
...
The shared [Manpu contract](../../../packages/game_presentation/addons/game_presentation/actors/MANPU.md) also accepts
...
```sh
Godot --headless --path godot/games/afterlight --script res://voice/export_inventory.gd -- --status
```
