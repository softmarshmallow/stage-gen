...
This turns a level into a small declaration and checks all of that before anything is written.
    ...
    uv run python godot/games/bellweather/tools/author_terrain.py --plan crowncrag-road --check
    uv run python godot/games/bellweather/tools/author_terrain.py --plan crowncrag-road --emit-toml
"""
