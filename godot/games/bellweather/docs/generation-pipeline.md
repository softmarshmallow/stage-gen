...
> [asset taxonomy](../../../../docs/spec/asset-taxonomy.md)). The sibling
> [runner](../../iron_petal_unit/docs/runner.md), [dialogue-scene](../../the_grain/docs/dialogue-scene-assets.md), and
> [point-and-click room](../../the_grain/docs/pointclick-room.md) recipes each declare their own graph
...
[asset taxonomy](../../../../docs/spec/asset-taxonomy.md), such as `2d/sideview/platformer/motion_atlas.generate` —
...
([`package_types.py`](../pipeline/src/bellweather_pipeline/package_types.py) declares
...
| --- | --- |
| Authored package capture, membership, and closure | [`game_package.py`](../../../tools/python/src/demo_game_collection/game_package.py) over [`package_capture.py`](../../_shared/python/src/demo_game_tools/io/package_capture.py) |
| The platformer member's resolution and cross-contract rules | [`validation.py`](../pipeline/src/bellweather_pipeline/validation.py) |
| Asset-level fan-out, dependencies, typed ports, cache inputs, and provider-neutral image workload requirements | [`package_graph.py`](../pipeline/src/bellweather_pipeline/package_graph.py) |
| The recipe's node-type census: `type_id`, view archetype, capability and features, attempt policy, per-type cache contract version | [`package_types.py`](../pipeline/src/bellweather_pipeline/package_types.py) |
...
| Prepared-game document vocabulary over that engine | [`execution_graph.py`](../pipeline/src/bellweather_pipeline/execution_graph.py) |
...
| Side-view platformer resolve/plan/dispatch composition | [`package_executor.py`](../pipeline/src/bellweather_pipeline/package_executor.py) |
| Prepared-package map execution, canonicalization, cache, and review | [`prepared_world.py`](../pipeline/src/bellweather_pipeline/prepared_world.py) |
| Prepared-package cast, catalog, UI, soundtrack, binding, and review execution | [`prepared_content.py`](../pipeline/src/bellweather_pipeline/prepared_content.py) |
| Leaf provider retries, decoding, validation, and atomic persistence | Provider-neutral components and adapters |
| Runtime artifact binding and atomic publication | [`prepared_manifest.py`](../pipeline/src/bellweather_pipeline/prepared_manifest.py) |
...
[`runner.md`](../../iron_petal_unit/docs/runner.md); changing that fan-out requires regenerating its
...
`demo-games generate` requires `--input` pointing to a prepared directory or ZIP whose root
...
[Motion rebase](../../../../docs/spec/motion-rebase.md).
