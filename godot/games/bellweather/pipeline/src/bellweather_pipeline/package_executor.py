...
from bellweather_pipeline.prepared_integration import (
    PreparedIntegrationNodeHandler,
)
from bellweather_pipeline.prepared_manifest import PreparedManifestResult
...
class PreparedPackageExecutor(RecipeExecutor[ResolvedGamePackage, ExecutionGraph]):
    ...
    def __init__(
        ...
        *,
        input_resolver: Callable[[Path], ResolvedGamePackage] = resolve_game_package,
    ) -> None:
        super().__init__(config)
        self._input_resolver = input_resolver

    def _resolve(self, input_path: Path) -> ResolvedGamePackage:
        return self._input_resolver(input_path)
