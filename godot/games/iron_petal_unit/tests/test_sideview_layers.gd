...
func run(h: TestHarness) -> void:
	...
	var stage := RunnerStage.new()
	stage._package = package
	stage._config = {"rows": 18, "walkSurfaceRow": 14, "tilePx": 40}
	stage._build_bands({"layers": [
		{"plane": "foreground", "alpha_mode": "opaque", "vertical_anchor": "canvas_cover", "height": 720},
		{"layer_id": "test", "plane": "background", "order": 2, "parallax": 0.25,
		"image": "band.png", "width": 16, "height": 8, "vertical_anchor": "screen_top",
