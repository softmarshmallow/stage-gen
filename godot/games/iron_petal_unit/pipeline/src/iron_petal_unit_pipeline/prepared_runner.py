...
from iron_petal_unit_pipeline.manifest import (
    RUNTIME_TILE_PX as RUNTIME_TILE_PX,
)
from iron_petal_unit_pipeline.manifest import (
    build_manifest,
)
from iron_petal_unit_pipeline.manifest import (
    manifest_audio as manifest_audio,
)
from iron_petal_unit_pipeline.manifest import (
    manifest_gameplay as manifest_gameplay,
)
from iron_petal_unit_pipeline.manifest import (
    manifest_ground as manifest_ground,
)
from iron_petal_unit_pipeline.manifest import (
    manifest_rebase_multipliers as manifest_rebase_multipliers,
)
...
if TYPE_CHECKING:
    ...
    from iron_petal_unit_pipeline.track import RunnerSegmentChunk, RunnerTrack
...
class SideviewRunnerNodeHandler(RecipeNodeHandler):
    ...
    async def _assemble_manifest(self, node: Node) -> NodeExecutionResult:
        ...
        manifest = build_manifest(
            self._resolved,
            run_dir=self._run_dir,
            read_artifact=self._read_run_artifact,
            structural_material_identity=self._structural_material_identity,
        )
