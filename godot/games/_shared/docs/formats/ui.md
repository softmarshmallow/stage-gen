...
can draw one ([decision 0062](../../../../../docs/decisions/0062-the-pointer-belongs-to-every-host.md)), and
...
band fill (`godot/games/ember_hollow/scenes/hud/ui_kit.gd`). It draws no `inventory_panel`
