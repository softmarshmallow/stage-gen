...
> to camera aliases by the [asset taxonomy](../../../../../docs/spec/asset-taxonomy.md) and carried by
...
[generation specification](../../../ember_hollow/docs/generation-v1.md): perspective, an
...
The ratified TARGET
[map-generation contract](../../../bellweather/docs/map-generation-contract.md) reuses
...
The [asset taxonomy](../../../../../docs/spec/asset-taxonomy.md) refines this rule for module and
...
- select a game engine or engine coordinate convention for any recipe other
  than the one [decision 0057](../../../../../docs/decisions/0057-the-survival-game-runs-on-godot.md)
  rules on;
