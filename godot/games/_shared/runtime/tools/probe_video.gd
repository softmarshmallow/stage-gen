...
##
##   Godot --path godot/games/_shared/runtime -s res://tools/probe_video.gd -- <absolute .ogv path>
##   Godot --path godot/games/_shared/runtime --headless -s res://tools/probe_video.gd -- <path>
##
