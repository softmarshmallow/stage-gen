...
## Optional fixture selection is configured by the consuming test project.
static var DEFAULT_RUN_REF: String = str(ProjectSettings.get_setting("demo_tests/default_run", ""))
static var PINNED_PACKAGE: String = str(ProjectSettings.get_setting("demo_tests/pinned_package", ""))
static var VALIDATE_MANIFEST: Callable
static var LAYOUT_REF: String = ""
...
func package() -> HostRunDir:
	if _package == null:
		_package = HostRunDir.open(RUN_DIR, VALIDATE_MANIFEST, LAYOUT_REF)
	return _package
