...
const MODULE_FILES := [
	"res://scenes/view/ground.gd",
	"res://scenes/view/water.gd",
	"res://scenes/view/decals.gd",
	"res://scenes/view/shadows.gd",
	"res://scenes/view/cards.gd",
	"res://scenes/view/pieces.gd",
	"res://scenes/view/fire.gd",
	"res://scenes/view/puffs.gd",
	"res://scenes/view/splashes.gd",
	"res://scenes/view/strikes.gd",
	"res://scenes/view/weather_view.gd",
	"res://scenes/view/gallery.gd",
	"res://scenes/view/hurt_flash.gd",
	"res://scenes/view/warmth_veil.gd",
	"res://scenes/hud/hud.gd",
	"res://scenes/hud/craft_panel.gd",
	"res://scenes/hud/death_screen.gd",
	"res://scenes/hud/world_map.gd",
	"res://scenes/hud/pause_menu.gd",
	"res://scenes/audio/music.gd",
	"res://scenes/audio/sfx.gd",
]
...
const SHELL_FILE := "res://scenes/shell/shell.gd"
...
func _ready() -> void:
	...
	if package == null:
		...
		return
	_weather_script = _load_script("res://gameplay/systems/weather.gd")
	_input_script = _load_script("res://scenes/input.gd")
...
func _boot(next_world: SurvivalWorld) -> void:
	...
	environment_node = load("res://scenes/view/environment.gd").new()
	...
	vignette = load("res://scenes/view/vignette.gd").new()
