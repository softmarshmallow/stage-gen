...
```
Godot --path godot/games/ember_hollow -- --run <absolute run directory>
```
...
Godot --path godot/games/ember_hollow --rendering-driver metal \
      -s res://tools/devtools/ui_shots.gd -- --run <absolute run dir> --out <directory>
```
...
```
Godot --headless --path godot/games/ember_hollow -s res://tests/run_tests.gd \
...
```
Godot --path godot/games/ember_hollow --rendering-driver metal --disable-render-loop \
...
Godot --headless --path godot/games/ember_hollow -s res://tools/parity.gd \
      ...
      --script res://tests/fixtures/oblique_survival/replay/01-idle-summer-noon.json --out <abs jsonl> --quiet
```
...
looked states in `godot/games/ember_hollow/tests/test_cards.gd`'s `_look_geometry`.
