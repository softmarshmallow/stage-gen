...
> authority: `godot/games/ember_hollow/pipeline/src/ember_hollow_pipeline/layout.py` and
> `godot/games/ember_hollow/pipeline/src/ember_hollow_pipeline/gates.py`; the authored file is
...
thresholds are in `godot/games/ember_hollow/pipeline/src/ember_hollow_pipeline/gates.py` and the
