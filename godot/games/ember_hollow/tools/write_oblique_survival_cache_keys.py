...
reads and prices rather than a surprise on the next run.
    ...
    uv run python godot/games/ember_hollow/tools/write_oblique_survival_cache_keys.py
    uv run python godot/games/ember_hollow/tools/write_oblique_survival_cache_keys.py --write
...
PACKAGE = REPOSITORY_ROOT / "godot/games/ember_hollow/inputs"
