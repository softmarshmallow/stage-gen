...
const CARD_SHADER := "res://scenes/view/shaders/card.gdshader"
const CARD_SOFT_SHADER := "res://scenes/view/shaders/card_soft.gdshader"
const CARD_BLEND_SHADER := "res://scenes/view/shaders/card_blend.gdshader"
