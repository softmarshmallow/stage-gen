...
const Plates := preload("res://scenes/view/plates.gd")
const ProcNoise := preload("res://scenes/view/proc_noise.gd")
...
func setup(pkg, world, fu) -> void:
	...
	material.shader = load("res://scenes/view/shaders/ground.gdshader")
