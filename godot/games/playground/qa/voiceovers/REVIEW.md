...
```sh
/Users/universe/.local/bin/Godot --headless --path godot/games/playground --script res://qa/voiceover_checks.gd -- --game bishoujo_afterlight
/Users/universe/.local/bin/Godot --path godot/games/playground --script res://qa/voiceover_checks.gd -- --game bishoujo_afterlight --require-recordings --capture
```
