...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/godot/games/playground --script res://qa/opening-loop/native_smoke.gd -- --opening-variant a
```
