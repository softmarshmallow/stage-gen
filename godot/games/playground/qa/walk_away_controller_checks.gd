...
func _check_existing_controllers() -> void:
	var focus_checks = load("res://qa/actor_focus_checks.gd").new()
	focus_checks._check_engine()
	_errors.append_array(focus_checks._errors)
	var exit_checks = load("res://qa/character_exit_checks.gd").new()
	exit_checks._check_controller()
	_errors.append_array(exit_checks._errors)
	var cast_checks = load("res://qa/cast_transition_checks.gd").new()
	...
	var manpu_checks = load("res://qa/manpu_animation_checks.gd").new()
