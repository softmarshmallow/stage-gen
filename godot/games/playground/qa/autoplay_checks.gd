...
func _run() -> void:
	...
	_expect(_app.selected_game_id == "bishoujo_afterlight" and game._load_errors.is_empty(), "Run the initialized Afterlight host with --game bishoujo_afterlight.")
	if _errors.is_empty():
	...
	for path: String in ["res://games/bishoujo_afterlight/story.gd", "res://games/bishoujo_afterlight/root.gd", "res://games/bishoujo_afterlight/story_beats.gd", "res://games/bishoujo_afterlight/text/en.json", "res://games/bishoujo_afterlight/text/ko.json", "res://addons/game_presentation/audio/text_reveal_audio.gd", "res://qa/autoplay_checks.gd"]:
...
func _checkpoint_checks(game: Control) -> void:
	...
	game._toggle_pause()
	_expect(_app.open_route("game:presentation_lab"), "Autoplay must support a real Presentation Lab detour.")
	await _settle()
	...
	_expect(_app.open_route("game:bishoujo_afterlight"), "The autoplay checkpoint must return to Afterlight.")
	await _settle()
