...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/godot/games/playground -- --game presentation_lab --language ko
```
...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/godot/games/playground -- --game presentation_lab --route actor_motion_study --language ko
```
...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/godot/games/playground -- --game presentation_lab --route cast_pan_study --language ko
```
...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/godot/games/playground -- --game presentation_lab --route sigh_puff_study --language ko
```
...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/godot/games/playground -- --game presentation_lab --route ominous_study
```
...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/godot/games/playground -- --game presentation_lab --route sprite_burst_study --language ko
```
...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/godot/games/playground -- --game presentation_lab --route background_blackout_study --language ko
```
...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/godot/games/playground -- --game presentation_lab --route ambient_particles_study --language ko
```
...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/godot/games/playground -- --game presentation_lab --route transmission_voice_study --language ko
```
