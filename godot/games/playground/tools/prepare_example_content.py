...
CONTENT_DIRECTORIES = (
    "assets",
    "games/bishoujo_afterlight/assets",
    "games/bishoujo_afterlight/text",
    "games/bishoujo_afterlight/voice",
)
...
def content_files(project: Path) -> list[Path]:
    ...
    manifest = json.loads((project / "games/bishoujo_afterlight/voice/manifest.json").read_text())
