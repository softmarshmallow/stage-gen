...
[`story route`](../../games/command_link/game.gd) adds a speaker tab with an actor accent,
dialogue backing, and a clear primary progression action. The
[`menu`](../../games/command_link/menu.gd) gives the briefing action priority above eleven
...
[P27](../../USER_PROMPTS.md#p27); no generation contract or production module is
introduced here. Verification is recorded in [the prototype QA](../../QA.md).
