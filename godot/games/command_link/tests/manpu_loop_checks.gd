...
const LEGACY = preload("res://tests/manpu_animation_checks.gd")
const LEGACY_FOCUS = preload("res://tests/actor_focus_checks.gd")
const LEGACY_EXIT = preload("res://tests/character_exit_checks.gd")
