...
The snapshot is application-owned and packaged with ``stage-gen``.  It records
...
PLATFORMER_FIXTURE = "library/games/bellweather"
RUNNER_FIXTURE = "library/games/iron-petal-unit"
DIALOGUE_FIXTURE = "library/games/larkfield"
POINTCLICK_FIXTURE = "library/games/clockmakers_attic"
STOREFRONT_FIXTURE = "library/games/ember-hollow"
SURVIVAL_FIXTURE = "library/games/ember-hollow"
UNIVERSE_FIXTURE = "library/games/lantern_ferry"
