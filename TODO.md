...
- [ ] Alpha-test the pointer pick: a click in the empty corner of a card's rectangle still picks that card; reading the hit texel needs the card images kept CPU-side or a per-template mask ([host README](godot/README.md), "Playing it").
