...
> authority: `src/stage_gen/components/scenario/`, `godot/games/_shared/runtime/addons/demo_support/simulation/families/scenario/`, the
...
The [dialogue and cutscene sequence contract](../../godot/games/_shared/docs/formats/dialogue-and-cutscene-sequences.md)
...
is the conversation core in `godot/games/_shared/runtime/addons/demo_support/simulation/families/scenario/` generalized from one statement
...
| Term | Owner | Meaning |
| --- | --- | --- |
| `sequence` | [sequence contract](../../godot/games/_shared/docs/formats/dialogue-and-cutscene-sequences.md) | The canonical authored semantic graph. May be branching, timed, cinematic, or gameplay-coupled. Larger than any implementation. |
...
[case](../../godot/games/the_grain/docs/case.md): the scenario reads it and may never set it.
...
The Grain's [The Way In scenario](../../godot/games/the_grain/inputs/scenarios/e1_way_in.toml)
binds its [script](../../godot/games/the_grain/inputs/scenarios/e1_way_in.scenario)
...
[case](../../godot/games/the_grain/docs/case.md) is for.
...
(`godot/games/_shared/runtime/addons/demo_support/simulation/families/scenario/runtime.gd`). It owns no drawing, no asset paths, no engine
...
- restate or amend the [sequence contract](../../godot/games/_shared/docs/formats/dialogue-and-cutscene-sequences.md),
...
- [Case: the container above the narrative leaves](../../godot/games/the_grain/docs/case.md) — the authored beat
