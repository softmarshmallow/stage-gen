...
is the conversation core in `godot/legacy/runtime/families/scenario/` generalized from one statement
...
```text
godot/legacy/inputs/<game_id>/scenarios/<scenario_id>.toml       # declarations
godot/legacy/inputs/<game_id>/scenarios/<scenario_id>.scenario  # the script
```
...
(`godot/legacy/runtime/families/scenario/runtime.gd`). It owns no drawing, no asset paths, no engine
