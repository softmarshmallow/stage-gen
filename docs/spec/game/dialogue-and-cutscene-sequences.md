...
projections only inside `prepared-game-runtime-v7` and validates each declared
...
`prepared-game-runtime-v7` projection. They MUST NOT silently acquire unsupported
