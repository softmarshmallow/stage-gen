...
projections only inside `prepared-game-runtime-v5` and validates each declared
...
`prepared-game-runtime-v5` projection. They MUST NOT silently acquire unsupported
