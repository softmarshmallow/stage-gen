...
| 10 ✔ | K | **The room, the scene and the case**, and their browser surfaces are deleted together | fourteen clicks, twenty-five actions and nineteen actions unmoved; three picture gates at 5 of 5, 6 of 6 and 6 of 6, and 32 of 32 deliberate breaks caught; 9,619 lines and 134 tests gone; an adversarial pass afterwards found a plate two pixels short, six smaller faults and nine holes in the sheets themselves, all fixed and recorded; [0067](../decisions/0067-the-room-the-scene-and-the-case-are-retired-from-the-browser.md) |
