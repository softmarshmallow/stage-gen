...
the historical machine identifier `theme_art_direction_comparison_v1`, which
fixes the supported top-level fields and validates its exact two-input,
shared-seed, and six-handle compiler lineage.
