...
| `game-shell-v3` | `authored` | `stage_gen.components.game_shell.models:GameShell.kind` |
...
| `portrait-motion-plan-v2` | `generated` | `stage_gen.orchestration.portrait_motion:PORTRAIT_MOTION_PLAN_KIND` |
...
| `dialogue-scene-execution-graph-v6` | `graph` | `stage_gen.recipes.dialogue_scene.scene_graph:DIALOGUE_GRAPH_KIND` |
| `oblique-survival-execution-graph-v2` | `graph` | `stage_gen.recipes.oblique_survival.survival_graph:OBLIQUE_SURVIVAL_GRAPH_KIND` |
| `pointclick-room-execution-graph-v2` | `graph` | `stage_gen.recipes.pointclick_room.room_graph:POINTCLICK_GRAPH_KIND` |
| `portrait-motion-v2` | `graph` | `stage_gen.orchestration.portrait_motion:PORTRAIT_MOTION_GRAPH_KIND` |
| `sideview-platformer-execution-graph-v2` | `graph` | `stage_gen.recipes.sideview_platformer.execution_graph:EXECUTION_GRAPH_KIND` |
| `sideview-runner-execution-graph-v2` | `graph` | `stage_gen.recipes.sideview_runner.runner_graph:RUNNER_GRAPH_KIND` |
...
| --- | ---: | --- |
| `dialogue-scene-execution-graph-v5` | `5` | `stage_gen.recipes.dialogue_scene.scene_graph:DialogueSceneGraph.LEGACY_GRAPH_IDENTITIES` |
| `oblique-survival-execution-graph-v1` | `1` | `stage_gen.recipes.oblique_survival.survival_graph:ObliqueSurvivalGraph.LEGACY_GRAPH_IDENTITIES` |
| `pointclick-room-execution-graph-v1` | `1` | `stage_gen.recipes.pointclick_room.room_graph:PointClickRoomGraph.LEGACY_GRAPH_IDENTITIES` |
| `portrait-motion-v1` | `1` | `stage_gen.orchestration.portrait_motion:PortraitMotionGraph.LEGACY_GRAPH_IDENTITIES` |
| `sideview-platformer-execution-graph-v1` | `1` | `stage_gen.recipes.sideview_platformer.execution_graph:ExecutionGraph.LEGACY_GRAPH_IDENTITIES` |
| `sideview-runner-execution-graph-v1` | `1` | `stage_gen.recipes.sideview_runner.runner_graph:SideviewRunnerGraph.LEGACY_GRAPH_IDENTITIES` |
