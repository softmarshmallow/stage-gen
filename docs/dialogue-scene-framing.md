...
| [The mapper now](../godot/legacy/runtime/genres/dialogue_scene/framing.gd), which reproduces the three pinned values | measured rather than digested: 3.244 / 58.0 / 5.6 at zoom 70, and 0.308 and 1.37 normalised at 25 and 85 |
