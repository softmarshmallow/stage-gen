...
> [SDK](../../presentation-playground/addons/game_presentation/README.md) and
> [packaging](../../presentation-playground/PACKAGING.md) for P107 implementation.
...
Current source anchors: [animation](../../presentation-playground/presentation/animation/README.md),
[focus](../../presentation-playground/presentation/focus/README.md),
[Manpu](../../presentation-playground/presentation/manpu/README.md),
[exits](../../presentation-playground/presentation/transitions/README.md),
[handoff](../../presentation-playground/presentation/transitions/CAST_TRANSITIONS.md),
[camera contracts](../../presentation-playground/TOPOLOGY.md#component-contracts),
[fields](../../presentation-playground/presentation/effects/SCREEN_FIELDS.md),
[particles](../../presentation-playground/presentation/effects/SPRITE_PARTICLE_EMITTER.md),
[burst](../../presentation-playground/presentation/effects/SPRITE_BURST.md),
[audio](../../presentation-playground/presentation/narrative/TEXT_REVEAL_AUDIO.md),
[voice processing](../../presentation-playground/presentation/audio/VOICE_PROCESSING.md),
[contact](../../presentation-playground/presentation/interaction/README.md).
...
The existing integrated [stage](../../presentation-playground/presentation/stage.gd),
[stage profile](../../presentation-playground/presentation/stage_profile.gd),
[actor overlay](../../presentation-playground/presentation/actor_overlay.gd),
[opening](../../presentation-playground/presentation/opening.gd), tactical theme,
...
1. Replace hardcoded example media roots in [Afterlight's root](../../presentation-playground/games/bishoujo_afterlight/root.gd)
   with supplied bindings; keep the cast/story choices in that host.
2. Remove the fixed shared-art catalog dependency from the [cast presenter](../../presentation-playground/games/bishoujo_afterlight/cast_stage.gd).
...
[verification record](../../presentation-playground/QA.md#sdk-package-and-content-boundary-p107)
