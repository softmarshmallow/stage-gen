...
1. Select twelve source views with exact digests: Nami/Yuzu/Riko/Keeper standing,
   ...
   in the [playground roots](../../presentation-playground/games/bishoujo_afterlight/root.gd)
   and [tactical profile](../../presentation-playground/games/command_link/stage_profile.gd);
