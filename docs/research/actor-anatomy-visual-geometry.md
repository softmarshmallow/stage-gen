...
| Survival [manifest](../../godot/legacy/python/stage_gen_legacy/recipes/oblique_survival/manifest.py) and [fire placement](../../godot/hosts/oblique_survival/view/fire.gd) | Separate per-state prop anchors place flames. | Evidence of specialized attachment paths, not human anatomy. Keep such rules/extensions explicit rather than absorbing them into human landmarks. |
