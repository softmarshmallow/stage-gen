...
| Survival [manifest](../../godot/games/ember_hollow/pipeline/src/ember_hollow_pipeline/manifest.py) and [fire placement](../../godot/hosts/oblique_survival/view/fire.gd) | Separate per-state prop anchors place flames. | Evidence of specialized attachment paths, not human anatomy. Keep such rules/extensions explicit rather than absorbing them into human landmarks. |
...
1. Select twelve source views with exact digests: Nami/Yuzu/Riko/Keeper standing,
   ...
   in the [playground roots](../../godot/games/afterlight/root.gd)
   and [tactical profile](../../godot/games/command_link/stage_profile.gd);
