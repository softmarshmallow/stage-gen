...
`godot/legacy/tools/render_asset_scale_figures.py` composites both figures and prints the manifest digest it
...
```sh
uv run python godot/legacy/tools/render_asset_scale_figures.py \
