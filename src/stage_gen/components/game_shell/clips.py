...
from stage_gen.components.game_shell.layouts import ShellLayout
...
#: How many frames a reviewer is shown, and the grid they are laid out on. Four beats
#: across a clip is enough to see whether the look held; more is a wall.
CLIP_REVIEW_FRAME_COUNT = 4
CLIP_REVIEW_COLUMNS = 2
...
def clip_sample_times(seconds: float, *, count: int = CLIP_REVIEW_FRAME_COUNT) -> tuple[float, ...]:
