...
def build_repository_model_policy_projection(
    ...
    *,
    ...
    fixture_by_recipe = {
        "dialogue_scene": "library/games/larkfield",
        "oblique_survival": "library/games/ember-hollow",
        "pointclick_room": "library/games/clockmakers_attic",
        "sideview_platformer": "library/games/bellweather",
        "sideview_runner": "library/games/iron-petal-unit",
        "storefront": "library/games/ember-hollow",
        "universe_gallery": "library/games/lantern_ferry",
        "universe_semantic": "library/games/lantern_ferry",
    }
