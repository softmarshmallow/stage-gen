...
from stage_gen.recipes.portrait_motion import face_location as _implementation
...
async def run_locator(*args: Any, **kwargs: Any) -> dict[str, Any]:
    ...
    return await _implementation.run_locator(*args, **kwargs)
