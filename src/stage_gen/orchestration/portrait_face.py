...
from stage_gen.recipes.portrait_motion import face as _implementation
...
async def run_face_pipeline(*args: Any, **kwargs: Any) -> dict[str, Any]:
    ...
    return await _implementation.run_face_pipeline(*args, **kwargs)
