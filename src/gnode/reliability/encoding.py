...
#: Historical common families, retained for callers that display this vocabulary.
#: Persistence validates MIME syntax independently of installed modalities: a
#: caller can write e.g. model/gltf-binary without a ring-1 model service.
ARTIFACT_MEDIA_FAMILIES = ("application", "audio", "image", "text", "video")
...
def normalize_artifact_media_type(value: object) -> str:
    ...
    canonical ``type/subtype``. The engine validates syntax, not a list of
    installed modalities; callers own format-specific byte validation.
    """
