...
[ambient_particles.gd](../../addons/game_presentation/effects/particles/ambient_particles.gd) is a target-agnostic, sustained
...
[ambient_particle_checks.gd](../../qa/ambient_particle_checks.gd) checks seeded
...
```sh
/Users/universe/.local/bin/Godot --headless --path presentation-playground --log-file /tmp/ambient-particle-checks.log --script res://qa/ambient_particle_checks.gd
```
