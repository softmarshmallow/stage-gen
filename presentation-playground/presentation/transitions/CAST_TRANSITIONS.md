...
[cast_transition.gd](../../addons/game_presentation/actors/cast_transition.gd) coordinates the phases.
[Character Exit](README.md) supplies departure color and coverage, the shared
[Presentation Animation sampler](../animation/README.md) supplies entrance
opacity, and [motion_curve.gd](../../addons/game_presentation/motion/motion_curve.gd) supplies translation.
...
[cast_transition.json](../../addons/game_presentation/actors/presets/cast_transition.json) declares `version: 1`, `slots`,
...
[motion_curve_graph.gd](../animation/motion_curve_graph.gd) calls the same
...
authored story choices for [P25](../../USER_PROMPTS.md#p25), not a public cue schema.
...
The route in [routes/cast_transition.gd](../../demos/cast_transition.gd) adapts
...
acceptance belong in [QA.md](../../QA.md).
