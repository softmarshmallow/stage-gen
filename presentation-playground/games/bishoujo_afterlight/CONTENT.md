...
```sh
/Users/universe/.local/bin/Godot --path presentation-playground -- --game bishoujo_afterlight --content-root /absolute/prepared-content
```
...
```sh
/Users/universe/.local/bin/Godot --headless --path presentation-playground --log-file /tmp/afterlight-content.log --script res://qa/afterlight_external_content_checks.gd -- --content-root /absolute/prepared-content
```
