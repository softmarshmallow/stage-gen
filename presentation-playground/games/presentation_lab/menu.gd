...
## Concrete laboratory navigation. Story games do not own this browser.
...
func _ready() -> void:
	...
	_label("PRESENTATION LAB", Rect2(48, 35, 1184, 56), 38)
	...
	_story_buttons["bishoujo_afterlight"] = _button("Play Bishōjo: Afterlight", Rect2(424, 815, 360, 44), "game:bishoujo_afterlight")
...
func _build_collections() -> void:
	...
	_collection_buttons["afterlight"] = _button("Afterlight studies", Rect2(646, 250, 586, 240), "effects_menu")
	_label("Actor presentation, manpu, contact, transitions,\nlocation direction, and dialogue camera.", Rect2(76, 513, 518, 110), 21)
	_label("Walking Approach, Eye Transitions, Intertitle,\nCamera Drift, Actor Halo, Actor Motion, Sigh Puff,\nand Ominous Effects.", Rect2(674, 513, 530, 110), 21)
