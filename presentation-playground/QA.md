...
[packaging](PACKAGING.md), the [starter](starter_source/README.md), and
[SDK content checks](qa/SDK_CONTENT_CHECKS.md). Code/API and source UIDs are tracked
...
Evidence: [smoke result](qa/opening/smoke.json) and
[native title capture](qa/opening/title.png). This pass did not verify export
...
menu/demo links, and scaled input: [route log](qa/opening/routes.log).
...
[the tactical UI notes](presentation/ui/README.md). Existing artwork, fixed 1280×900 canvas,
...
[the tactical location review](art/rounds/tactical-locations-v1/REVIEW.md).
...
- Two 1080p/24 fps visual edits: A is exactly 540 frames / 22.5 seconds;
  ...
  without errors and contain no audio track. [Media checks](art/opening-v1/review/media-checks.json).
- Independent visual review accepts the final edits for local spike binding,
  ...
  source ranges remain excluded. [Review](art/opening-v1/review/FINAL_REVIEW.md).
- Native macOS Godot checks decode 1920×1080 frames, preserve the 1280×720 image
  ...
  [Selected opening A evidence](qa/opening-v1/a.json),
  [alternate B](qa/opening-v1/b.json), and
  [direct game bypass](qa/opening-v1/direct-game.json).
...
- All ten provider attempts are reconciled at $10.0886 against the authorized
  ...
  generation is scheduled. [Budget](art/opening-v1/budget.json).
...
Both A and B pass the native [loop smoke runner](qa/opening-loop/native_smoke.gd).
...
navigation after an explicit click. [A evidence](qa/opening-loop/a.json) and
[B evidence](qa/opening-loop/b.json) include frames, source hashes, opacity
samples, and no errors. [Independent review](qa/opening-loop/REVIEW.md) accepts
...
The native [probe](qa/native-resolution/probe.json) compares the former mode
...
The [native route suite](qa/native-resolution/routes.log) passes, including
...
The [native presentation suite](qa/native-resolution/presentation.log) also
...
repository-root `presentation-playground/`. Runtime code and all 19 prepared
...
- `Godot --path presentation-playground -- --validate-routes`: exit 0.
- `Godot --path presentation-playground -- --validate`: exit 0, including
  native-resolution output, fixed layout, scaled input, and manpu proportions.
- `Godot --path presentation-playground --quit-after 120`: exit 0 for the
...
under `/tmp/presentation-playground-relocation-{routes,presentation,opening}.log`.
...
[Afterlight](games/bishoujo_afterlight/README.md) replaces the reserved dating
root with a short playable scene and its own camera study. It owns its UI and
uses the [Walking Approach controller](presentation/camera/WALKING_APPROACH.md)
...
[placeholders.json](games/bishoujo_afterlight/assets/placeholders.json) retains
...
```sh
Godot --headless --path presentation-playground --script res://qa/walking_approach_checks.gd
Godot --path presentation-playground --script res://qa/afterlight_checks.gd -- --game bishoujo_afterlight --capture-afterlight
Godot --headless --path presentation-playground --script res://qa/composition_checks.gd
```
...
The [terminology dictionary](TERMINOLOGY.md) records these names, example uses,
...
```sh
Godot --headless --path presentation-playground --script res://qa/eye_transition_checks.gd
Godot --path presentation-playground --script res://qa/eye_transition_integration_checks.gd -- --game bishoujo_afterlight --capture-eye-transitions
```
...
[The asset catalog](games/bishoujo_afterlight/assets/catalog.json) binds active
...
```sh
/Users/universe/.local/bin/Godot --headless --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/afterlight_ensemble_checks.gd -- --game bishoujo_afterlight
/Users/universe/.local/bin/Godot --headless --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/presentation_lab_checks.gd
```
...
```sh
/Users/universe/.local/bin/Godot --headless --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/walk_away_controller_checks.gd
/Users/universe/.local/bin/Godot --headless --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/walk_away_integration_checks.gd
```
...
```sh
/Users/universe/.local/bin/Godot --headless --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/one_shot_manpu_checks.gd
/Users/universe/.local/bin/Godot --headless --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/one_shot_manpu_integration_checks.gd
```
...
```sh
/Users/universe/.local/bin/Godot --headless --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/afterlight_input_checks.gd -- --game bishoujo_afterlight
```
...
```sh
/Users/universe/.local/bin/Godot --headless --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/text_reveal_audio_checks.gd -- --game bishoujo_afterlight --language ko
```
...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/afterlight_ensemble_checks.gd -- --game bishoujo_afterlight --language ko --capture-ensemble
```
...
visual review are retained in [transmission-v2/REVIEW.md](qa/transmission-v2/REVIEW.md).
...
Independent [visual review](qa/hologram-defaults/REVIEW.md) passes for eight
...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/hologram_defaults_checks.gd
```
...
[lab controls](qa/waking-eye/lab-peek-1280.png),
[story peek](qa/waking-eye/story-peek-1280.png),
[reopening](qa/waking-eye/story-reopening-1280.png), and
[full reveal](qa/waking-eye/story-open-2560.png) retain the softened edge and
...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/waking_eye_integration_checks.gd -- --game bishoujo_afterlight --capture-waking
```
...
[visual review](qa/keeper-intensity/REVIEW.md) accepts the stronger surroundings,
...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/keeper_intensity_checks.gd -- --game bishoujo_afterlight
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/corruption_pattern_checks.gd
```
...
and [visual review](qa/sprite-burst/REVIEW.md) record the inspected evidence.
...
```sh
/Users/universe/.local/bin/Godot --headless --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/sprite_burst_checks.gd
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/sprite_burst_integration_checks.gd -- --game bishoujo_afterlight
```
...
[visual review](qa/background-blackout/REVIEW.md) record the evidence. Log:
...
```sh
/Users/universe/.local/bin/Godot --headless --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/background_blackout_checks.gd
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/background_blackout_integration_checks.gd -- --game bishoujo_afterlight
```
...
modes still play and reset. The independent [visual review](qa/quick-approach/REVIEW.md)
...
```sh
/Users/universe/.local/bin/Godot --headless --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/actor_blocking_checks.gd
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/quick_approach_integration_checks.gd -- --game bishoujo_afterlight
```
...
fixed. See the independent [visual review](qa/cast-pan/REVIEW.md) and
...
```sh
/Users/universe/.local/bin/Godot --headless --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/layer_pan_checks.gd
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/cast_pan_integration_checks.gd -- --game bishoujo_afterlight
```
...
See the [visual review](qa/looping-manpu/REVIEW.md) for artifact-bound evidence
...
```sh
/Users/universe/.local/bin/Godot --headless --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/manpu_loop_checks.gd
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/looping_manpu_integration_checks.gd -- --game bishoujo_afterlight --language ko
```
...
loop remains. See the [visual review](qa/falling-sweat/REVIEW.md) and
...
```sh
/Users/universe/.local/bin/Godot --headless --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/one_shot_manpu_checks.gd
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/one_shot_manpu_integration_checks.gd -- --game bishoujo_afterlight --language ko --falling-sweat-only
```
...
[Point Contact](presentation/interaction/README.md), extracted from the tactical
...
The [generation record](art/rounds/afterlight-contact-v1/records/nami-contact.json),
[prompt](art/rounds/afterlight-contact-v1/prompts/nami-contact.txt), and
[independent art review](art/rounds/afterlight-contact-v1/REVIEW.md) record the
...
[Focused native contact checks](qa/afterlight_contact_checks.gd) cover real
...
[the contact review](qa/contact-afterlight/REVIEW.md).
...
[Focused voiceover checks](qa/voiceover_checks.gd) independently classify the
...
[the focused review](qa/voiceovers/REVIEW.md) records its ten source hashes,
...
[Autoplay checks](qa/autoplay_checks.gd) pass headless and in the native renderer.
...
[The focused review](qa/autoplay/REVIEW.md) records the final source hashes and
...
[Focused source-bound evidence](qa/ambient-transmission/REVIEW.md) records the
...
recordings. [Audio evidence](qa/transmission-audio/REVIEW.md) explicitly leaves
