...
```sh
Godot --path presentation-playground -- --game command_link
Godot --path presentation-playground -- --game bishoujo_afterlight
Godot --path presentation-playground -- --game presentation_lab --route approach_study
Godot --path presentation-playground -- --game presentation_lab --route eye_study
Godot --path presentation-playground -- --game presentation_lab --route effects_menu
Godot --path presentation-playground -- --route demos/dialogue_camera
Godot --path presentation-playground --script res://qa/composition_checks.gd
```
