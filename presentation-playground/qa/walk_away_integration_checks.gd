...
const ART_ROOT = preload("res://games/bishoujo_afterlight/root.gd")
const CAST_STAGE = preload("res://games/bishoujo_afterlight/cast_stage.gd")
const CAPTURES := "res://qa/walk-away"
...
func _check_integrated_exits() -> void:
	var scene := await _open("game:presentation_lab/demos/dialogue")
...
func _check_integrated_bounce() -> void:
	var scene := await _open("game:presentation_lab/demos/actor_focus")
	_legacy_neutral(scene)
...
func _check_handoff_resume() -> void:
	...
	await _open("game:presentation_lab/actor_motion_study")
...
func _check_lab_controls() -> void:
	var lab := await _open("game:presentation_lab/actor_motion_study")
