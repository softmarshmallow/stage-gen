...
```sh
/Users/universe/.local/bin/Godot --path presentation-playground --log-file /tmp/ambient-transmission-native.log --script res://qa/ambient_transmission_integration_checks.gd -- --game bishoujo_afterlight --language ko --capture-atmosphere
```
