...
const BLACKOUT_OUTPUT := "res://qa/background-blackout"
...
func _run() -> void:
	...
	var sources := {}
	for source: String in ["res://addons/game_presentation/transitions/background_blackout.gd", "res://games/bishoujo_afterlight/story.gd", "res://games/bishoujo_afterlight/story_beats.gd", "res://games/presentation_lab/afterlight/background_blackout_study.gd", "res://games/presentation_lab/afterlight/effects_menu.gd"]:
...
func _laboratory_blackout(factor: int) -> void:
	_expect(_app.open_route("game:presentation_lab/background_blackout_study"), "Background Blackout must have a dedicated study route.")
	await _settle()
	var lab := _active()
	...
	_expect(_app.open_route("game:bishoujo_afterlight"), "The lab must return to the saved episode.")
	await _settle()
