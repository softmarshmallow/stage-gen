...
```sh
/Users/universe/.local/bin/Godot --path /Users/universe/Documents/shared/stage-gen/presentation-playground --script res://qa/transmission_audio_checks.gd --log-file /tmp/transmission-audio-native.log
```
