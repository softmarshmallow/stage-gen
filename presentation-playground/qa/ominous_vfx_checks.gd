...
const DIRECTORY := "res://qa/ominous-vfx"
var _app: Control
...
func _run() -> void:
	...
	await process_frame
	_expect(_app.open_route("game:presentation_lab/ominous_study"), "The dedicated ominous study must be routable.")
	await process_frame
	...
	_expect(_app.open_route("game:presentation_lab/effects_menu"), "The study must return to its laboratory menu.")
	await process_frame
	await process_frame
