...
endings. Its Godot [runtime](../godot/families/scenario/runtime.gd) already
serves standalone dialogue and case composition. The
[dialogue leaf](../godot/hosts/common/dialogue_leaf.gd) renders that state.

The existing [room runtime](../godot/genres/pointclick_room/state.gd) owns
hotspots, inspect/use, item selection, inventory, prerequisites, reveals, and
puzzle effects. The [case runtime](../godot/genres/case/runtime.gd) composes
