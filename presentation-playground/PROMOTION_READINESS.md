...
repository-root `presentation-playground/`, with source under Git. The intact
...
[Bishōjo: Afterlight](games/bishoujo_afterlight/README.md), with an independently
...
- [Cast Transition](presentation/transitions/CAST_TRANSITIONS.md) assumes three registered
...
- [Dialogue Camera](presentation/camera/DIALOGUE_CAMERA.md) restores its saved motion, while
  [Actor Focus](presentation/focus/README.md) and [Manpu Introduction](presentation/manpu/README.md) resume
...
- The [case host](../godot/hosts/case/main.gd) explicitly selects room or
...
- The shared [dialogue leaf](../godot/hosts/common/dialogue_leaf.gd) loads a
